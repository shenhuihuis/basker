    ...
    <div class="logistics">
        ...
        <div class="sebox">
            <div class="selected">
                ...
                <router-link :to="{'name':'completed_add',params:{id:1}}" class="add">添加</router-link>
            </div>
        </div>
        <div class="listbox">
            <table cellpadding=0 cellspacing=0>
                ...
                <tbody>
                    <tr>
                        ...
                        <td>xxx</td>
                        <td>
                            <router-link :to="{'name':'completed_details',params:{id:1}}">查看</router-link>
                        </td>
                    </tr>
                </tbody>
            </table>
