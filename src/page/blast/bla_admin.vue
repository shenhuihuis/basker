        ...
        <div class="logistics" v-else>
            ...
            <div class="consys">
                <div class="appform">
                    <div class="clearbox">
                        <div class="inputbox">
                            <label class="el-form-item__label">人员姓名</label>
                    ...
                    <div class="clearbox">
                        <div class="inputbox">
                            <label class="el-form-item__label">实际居住地</label>
                            <el-input v-model="form.name" placeholder="请输入内容"></el-input>
                        </div>
                        <div class="inputbox">
                    ...
                    <div class="clearbox">
                      ...
                      <div class="clearbox">
                        <div class="inputbox" style="with:50%;float:left;height:40px;">
                    ...
                    <div class="clearbox">
                        <div class="inputbox">
                            <label class="el-form-item__label">系统账号</label>
                            <el-input v-model="form.name" placeholder="请输入内容"></el-input>
                        </div>
                        <div class="inputbox">
                            <label class="el-form-item__label">系统密码</label>
                            <el-input v-model="form.name" placeholder="请输入内容"></el-input>
                        </div>
                    </div>
                    <div class="clearbox">
                    ...
                    <div class="clearbox">
                        <div class="inputbox">
                            <label class="el-form-item__label">人像照片1</label>
                            <div class="el-input">
                                <div class="upload">
                                    <input type="file"> <i class="el-icon-upload"></i>
                                </div>
                        ...
                        <div class="inputbox">
                            <label class="el-form-item__label">人像照片2</label>
                            <div class="el-input">
                                <div class="upload">
                                    <input type="file"> <i class="el-icon-upload"></i>
                                </div>
